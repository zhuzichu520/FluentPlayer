...
0x68,0x18,0x0,0x0,0x32,0x36,0x34,0x31,
...
aotContext->initGetEnumLookup(25, []() { static const auto t = QMetaType::fromName("Fluent_Awesome"); return t; }().metaObject(), "Fluent_AwesomeType", "FavoriteStarFill");
if (aotContext->engine->hasError())
    return int();
}
// generate_Jump
...
aotContext->initGetEnumLookup(27, []() { static const auto t = QMetaType::fromName("Fluent_Awesome"); return t; }().metaObject(), "Fluent_AwesomeType", "FavoriteStar");
if (aotContext->engine->hasError())
    return int();
}
label_1:;
