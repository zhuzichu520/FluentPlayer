...
0xa8,0x12,0x0,0x0,0x32,0x36,0x34,0x31,
...
0x0,0x0,0x0,0x0,0xa3,0xc2,0x7e,0xc,
0xaa,0x9d,0x4e,0xd6,0x7b,0xf2,0x3d,0x2b,
0x2f,0xd1,0x80,0xd5,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
r2_2 = 100;
// generate_CmpLt
r2_0 = std::move(r8_0) < std::move(r2_2);
// generate_JumpFalse
if (!r2_0) {
    goto label_2;
}
...
// generate_GetLookup
while (!aotContext->getObjectLookup(23, r2_2, &r2_1)) {
aotContext->setInstructionPointer(19);
aotContext->initGetObjectLookup(23, r2_2, QMetaType::fromType<double>());
if (aotContext->engine->hasError())
    return double();
}
// generate_StoreReg
